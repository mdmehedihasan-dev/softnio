    ...
    >
      <div className="w-[90%] md:w-[80%] py-16 flex flex-col md:flex-row relative items-center mx-auto">
        ...
        <div className="relative flex justify-center w-full md:w-1/2 md:justify-end">
          <img
            className=" opacity-100 md:opacity-100 w-[90%]  sm:w-[60%] md:w-[80%] lg:w-auto"
          ...
          <img
            ...
            alt=""
          />
          <div className="bg-[#FEBF00] absolute -right-[-40px] md:-right-16 bottom-3 md:bottom-0  w-[100px] md:w-[124px] flex justify-center items-center h-[100px] md:h-[124px] rounded-full">
